...
const Interest = () => {
  ...
  return (
    <>
      <Head>
        <title>Daily Count 데일리 카운트 - 적금 계산기</title>
        <meta charset="utf-8" />
        <meta name="referrer" content="always" />
        <meta
          name="description"
          content="데일리 카운트, 당신의 일상 속 모든 계산기, 적금 계산기"
        />
        ...
        <meta
          name="keywords"
          content="데일리 카운트, 계산기, 일반 계산, 적금 계산기, 적금 계산기, 예금 계산기, 만나이 계산기, 시급 계산, 단위 환산, 단위 계산, 날짜 계산, 글자수 계산, 비만도 계산, 퍼센트 계산, 길이 계산, 넓이 계산, 무게 계산, 부피 계산, 온도 계산, 압력 계산, 속도 계산, 연비 계산, 데이터 계산"
        />
        <meta name="robots" content="index,follow" />
        <meta
          property="og:site_name"
          content="Daily Count 데일리 카운트, 당신의 일상 속 계산기 - 적금 계산기"
        />
        <meta
          property="og:image"
          content="/DailyCount.png"
          alt="Daily Count 데일리 카운트, 당신의 일상 속 계산기 - 적금 계산기"
        />
        <meta
          property="og:title"
          content="daily-count 데일리 카운트, 당신의 일상 속 계산기 - 적금 계산기"
        ...
        <meta
          ...
          content="데일리 카운트, 당신의 일상 속 계산기 - 적금 계산기"
        />
        ...
        <div className="Interest">
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-4" controlId="exampleForm.ControlInput2">
              <Form.Label>
                <h5 style={{ marginTop: "20px" }}>적금 기간</h5>
              </Form.Label>
              <Form.Control
                type="number"
                min="0"
